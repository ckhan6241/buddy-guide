...
const Memory = (props) => {
  ...
  return (
    <Flex {...styles.container} flexDirection='column'>
      ...
      <Flex>
        <View width='50%' flex='1'>
          <img src={ imageUrl } display='block' width='100%'/>
        </View>
...
const GuideDetailComponent = (props) => { 
  const { data, theme, height, prev, next  } = props
  ...
  return (
  <View justifyContent='space-around' overflow='scroll' position='relative' height={height} onClick={ () => {window.location='#/home-page/'+prev} }>
    ...
    <Flex width= { '70%' } {...styles.container}>
      ...
      <p {...styles.overviewContainer}> <strong> Availability: </strong> { availability } </p>
      <p {...styles.overviewContainer}> <strong> Activities: </strong> { activities } </p>
      <p {...styles.overviewContainer}> <strong> About me: </strong> { aboutMe } </p>
      <p {...styles.overviewContainer}> <strong> I will welcome you with: </strong> { welcomeYouWith } </p>
    ...
    <Flex {...styles.arrows} height={ height } flexDirection='column' alignItems='center'
        ...
        onClick={ () => {window.location='#/home-page/'+next} }>
